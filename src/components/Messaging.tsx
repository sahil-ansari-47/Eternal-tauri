...
const Messaging = () => {
  ...
  return (
    <div className="h-full w-full bg-p5 flex flex-col text-p6 border border-neutral-500 overflow-hidden">
      {/* Messages */}
      <SignedIn>
        {!activeChatKey && (
          <div className="flex w-full h-full divide-x divide-neutral-500">
            ...
            <div className="h-full w-full flex flex-col">
              {chatMode === "private" ? (
                <>
                  <h1 className="text-xl p-4">Direct Messages</h1>
                  ...
                  {userData?.friends?.map((friend) => (
                    <div
                      key={friend.username}
                      className="p-4 flex items-center gap-4 cursor-pointer hover:bg-neutral-500"
                      onClick={() => {
                        const chatKey = `chat:${[
                          userData.username,
                          friend.username,
                        ...
                        setPendingMessages((prev) =>
                          prev.filter((message) => message.chatKey !== chatKey)
                        );
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-between">
                        ...
                        {pendingMessages.filter(
                          ...
                          <div className="text-neutral-400 font-semibold text-sm truncate max-w-40">
                            {(() => {
                ...
                <div className="flex flex-col">
                  ...
                  {userData?.groups?.map((group) => (
                    <div
                      key={group.roomId}
                      className="p-4 cursor-pointer flex gap-4 items-center hover:bg-neutral-500"
                      onClick={() => {
                ...
                >
                  ...
                  <TabsContent value="friends">
                    <Input
                      ...
                      className="mx-2 w-[calc(100%-16px)] mb-4 py-6"
